        ...
        {activeTab === 'Home' && (
          <div className="p-8 mt-4 overflow-hidden">
            <div className="text-center mb-10">
              <h1 className="text-4xl font-black text-gray-900 mb-4">BlazeWorks 3D</h1>
              <p className="text-gray-500 max-w-2xl mx-auto">ยินดีต้อนรับสู่บริการพิมพ์ 3 มิติ ระบบ FDM คุณภาพสูง การันตีความละเอียดและรวดเร็ว</p>
            </div>
