    ...
    <div className="min-h-[calc(100vh-80px)] w-full bg-gradient-to-br from-blue-50 to-emerald-50 flex flex-col justify-between">
      <div className="flex-1 flex items-center justify-center p-4">
        <div className="bg-white p-8 rounded-3xl shadow-xl border border-gray-100 w-full max-w-md">
          <h2 className="text-3xl font-black text-gray-800 text-center mb-6">สมัครสมาชิก</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            >
              {isLoading ? 'กำลังสมัครสมาชิก...' : 'สมัครสมาชิก'} <ArrowRight size={18} />
            </button>
          </form>

          <div className="mt-6 text-center text-sm text-gray-600">
            มีบัญชีอยู่แล้ว?{' '}
            <button onClick={() => setActiveTab('Login')} className="text-[#72D1B7] font-bold hover:underline">
              เข้าสู่ระบบเลย
            </button>
          </div>
        </div>
